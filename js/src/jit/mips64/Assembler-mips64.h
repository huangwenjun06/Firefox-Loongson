...
static MOZ_CONSTEXPR_VAR Register AsmJSIonExitRegReturnData = JSReturnReg;
static MOZ_CONSTEXPR_VAR Register AsmJSIonExitRegReturnType = JSReturnReg;
...
// MIPS64 enums for instruction fields
enum Opcode {
...
#if (defined(__mips_hard_float) && !defined(__mips_single_float)) || defined(JS_MIPS64_SIMULATOR)
        return true;
#else
        return false;
#endif
