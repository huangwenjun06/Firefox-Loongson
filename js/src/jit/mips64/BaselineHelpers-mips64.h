...
#ifndef jit_mips64_BaselineHelpers_mips64_h
#define jit_mips64_BaselineHelpers_mips64_h
...
{
    EmitCreateStubFrameDescriptor(masm, a6);
    masm.push(a6);
    masm.call(target);
}
...
#endif /* jit_mips64_BaselineHelpers_mips64_h */
